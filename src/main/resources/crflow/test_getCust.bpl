...
<flow xmlns="http://www.sunline.cn/bpl" label="" author="" createDate="21-11-9 下午4:36" packageName="cn.sunline.adp.crflow" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.sunline.cn/bpl BPL.xsd">
  ...
  <node id="INVOKE0" xsi:type="INVOKE" label="Java组件0" islogger="false">
    ...
    <rectangle x="198" y="244" width="32" height="32"/>
    <labelRectangle x="180" y="277" width="69" height="17"/>
    <pojo class="cn.sunline.edsp.busi.cr.QuickstarBizlet" method="testA">
